...
<!-- MANPAGE: BEGIN EXCLUDED SECTION -->
[![Windows](https://img.shields.io/badge/-Windows_x64-blue.svg?style=for-the-badge&logo=windows)](https://github.com/yobserveroftime02/yt-dlp-daily/releases/latest/download/yt-dlp.exe)
...
File|Description
:---|:---
[yt-dlp_x86.exe](https://github.com/observeroftime02/yt-dlp-daily/releases/latest/download/yt-dlp_x86.exe)|Windows (Win7 SP1+) standalone x86 (32-bit) binary
